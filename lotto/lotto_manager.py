...
class Lotto:
    ...
    def __init__(self, ticket):
        ...
        for b in range(1, self.ticket + 1):
            ...
            number_choose = choose_number.Choose_number.number(
                number_of_game, type_bills)
            ...
            # builds the ticket
            ticket = ticket_creator.Ticket(
                b, type_of_game, city, number_choose, number_generators, amount_bet)
           ...
           # check if the ticket object is winning or not
            ...
            for tk in ticket_creator.Ticket.ticket:
                search_win = search_winning.Search_winning(
                    extraction.Extraction.extraction, tk)
                ...
                for win in search_win.winning_play:
                    money = prizes.Prizes(
                        type_bill.Type_bill.amount_played, win, quantity_numbers)

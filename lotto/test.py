...
class Test_ticket_creator(unittest.TestCase):
    def setUp(self):
        self.ticket_1 = ticket_creator.Ticket(1, type_bill.Type_bill(), city_bill.City('bari'), choose_number.Choose_number(
        ), generator_number.Generator(), type_bill.Type_bill(), type_bill.Type_bill.amount_bet())
    ...
    def test_ticket(self):
        ...
        self.assertIsInstance(self.ticket_1.quantity,
                              choose_number.Choose_number)
        self.assertIsInstance(self.ticket_1.n_g, generator_number.Generator)
        self.assertIsInstance(self.ticket_1.amount,
                              type_bill.Type_bill.amount_bet)
